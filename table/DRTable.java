...
/********************************************************************
* @(#)DRTable.java 1.00 10/05/27
* Copyright © 2010-2015 by Richard T. Salamone, Jr. All rights reserved.
*
* DRTable: Extends JTable to use renders and editors for DataField
...
* DRTable will add a mouse listener to the column headers that calls the
* model's sort method.
*
...
* 20150921 rts version use DataRecord (before was just "unrelated" fields)
* 20151027 rts autoselects first element when table is reset
*******************************************************/
import com.shanebow.dao.*;
import com.shanebow.dao.edit.*;
import com.shanebow.util.SBLog;
import com.shanebow.ui.LAF;
import com.shanebow.ui.SBTable;
...
public class DRTable<Record extends DataRecord>
	extends SBTable<Record>
	{
...
//common contructor code
	...
	public DRTable(SBTableModel<Record> tm)
		{
		super(tm);
		}
	...
	@Override public void tableChanged(javax.swing.event.TableModelEvent e) {
		...
		if (e.getLastRow() > 0 && e.getFirstRow() == 0
		&&  e.getType() == javax.swing.event.TableModelEvent.UPDATE)
//		&&  getModel().getRowCount() > 0)
			try { setRowSelectionInterval(0, 0); }
			catch (Exception ignore) {} // empty table
		}
